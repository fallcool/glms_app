...
app.controller('CourseTakeCtrl',function($scope,CourseService,$http,$rootScope,$stateParams,$filter,$cordovaCamera,$cordovaImagePicker,$ionicPlatform,$cordovaFileTransfer,ionicToast,resolvedItems,htmlValidationError){
